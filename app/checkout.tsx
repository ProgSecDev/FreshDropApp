    ...
    <SafeAreaView className='flex-1 bg-surface' edges={["top"]}>
        ...
        <ScrollView className='flex-1 px-4 mt-4'>
            ...
            {selectedAddress ? (
                ...
                <TouchableOpacity 
                onPress={()=> router.push('/addresses')}
                className='bg-white p-6 rounded-xl mb-6 items-center justify-center border-dashed border-2
                border-gray-100'>
            ...
            >
                ...
                <View className='ml-3 flex-1'>
                    ...
                    <Text className='text-secondary text-xs mt-1'>Pay with Credit or Debit Card</Text>
                </View>
        ...
        <View className='p-4 bg-white shadow-lg border-t border-gray-100'>
            ...
            <View className='flex-row justify-between mb-6'>
                ...
                <Text className='font-bold text-xl'>${total.toFixed(2)}</Text>
            </View>
            {/* Place Order Button */}
